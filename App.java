...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        int diaFechaUnoE = 0, diaFechaDosE = 0, diaFechaTresE = 0, mesFechaUnoE = 0, mesFechaDosE = 0,
                mesFechaTresE = 0;
        ...
        System.out.println(
                "\nA continuación se muestran la diferencias entre las fechas propuestas y la fechas de entrega por parte del estudiante\n");

        System.out.println(
                "\nFecha de entrega de la actividad evaluativa del momento 1 por parte del estudiante: " + diaFechaUnoE
                        + "/" + mesFechaUnoE + "/" + "/2025");
        if (difM1d > 0 || difM1m>0) {
            System.out.println("La diferencia entre la fecha planteada y la fecha en que se entregó es: " + difM1d
                    + " días " + difM1m + " meses");
        } 
            ...
            System.out.println("\n La actividad evaluativa del momento 1 se entregó a tiempo");

        }

        System.out.println(
                "\nFecha de entrega de la actividad evaluativa del momento 2 por parte del estudiante: " + diaFechaDosE
                        + "/" + mesFechaDosE + "/" + "/2025");

        if (difM2d >0 || difM2m>0) {
            System.out.println("La diferencia entre la fecha plateada y la fecha en que se entregó es: " + difM2d
            + " días " + difM2m + " meses");

        } 
        

        else { System.out.println("\n La actividad evaluativa del momento 2 se entregó a tiempo");


        }

        System.out.println(
                "\nFecha de entrega de la actividad evaluativa del momento 3 por parte del estudiante: " + diaFechaTresE
                        + "/" + mesFechaTresE + "/" + "/2025");

        if (difM3d > 0 || difM3m>0 ) {
            System.out.println("La diferencia entre la fecha planteada y la fecha en que se entregó es: " + difM3d
                    + " días " + difM3m + " meses");
        ...
        else { System.out.println("\n La actividad evaluativa del momento 3 se entregó a tiempo");
